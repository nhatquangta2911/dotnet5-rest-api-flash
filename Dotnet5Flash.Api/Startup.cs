...
namespace Dotnet5Flash.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IItemsRepository, SqlServerItemsRepository>();
            ...
            services.AddDbContextPool<ItemsContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ItemContextConnectionString")));
